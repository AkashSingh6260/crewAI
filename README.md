# 🤖 Multi-Agent AI Automation System using CrewAI

A powerful multi-agent automation framework built with CrewAI that enables autonomous AI agents to collaborate and solve complex tasks efficiently.
...
- LLM Support (OpenAI, Ollama, Gemini, etc.)
...
- Produces markdown outputs

## 📋 Workflow

1. User provides a topic.
2. Research Agent gathers information.
3. Reporting Agent analyzes findings.
4. Final report is generated automatically.
...
- Faster research automation
- Reduced manual effort
- Improved report generation
- Better task delegation using AI agents
